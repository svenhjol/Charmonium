...
public class ConfigHelper {
    ...
    public static void createConfig(String mod, Map<String, CharmoniumModule> modules) {
        ...
        for (String moduleName : moduleNames) {
            CharmoniumModule module = modules.get(moduleName);
            ...
            classFields.forEach(classField -> {
                try {
                    ...
                    Charmonium.LOG.error("Failed to set config for " + moduleName + ": " + e.getMessage());
                }
            });
        }
        ...
        try {
            ...
            buffer.close();
            Charmonium.LOG.debug("Written config to disk");

        } catch (Exception e) {
            Charmonium.LOG.error("Failed to write config: " + e.getMessage());
        }
    }
