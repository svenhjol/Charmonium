...
public class Savanna implements SoundType<BiomeSound> {
    ...
    public Savanna() {
        daySound = SoundEvent.createVariableRangeEvent(new ResourceLocation(Charmonium.ID, "biome.savanna.day"));
        nightSound = SoundEvent.createVariableRangeEvent(new ResourceLocation(Charmonium.ID, "biome.savanna.night"));
    }
