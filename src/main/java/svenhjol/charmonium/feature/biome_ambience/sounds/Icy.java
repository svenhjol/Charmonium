...
public class Icy implements ISoundType<BiomeSound> {
    ...
    public Icy() {
        DAY_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.instance().makeId("biome.icy.day"));
        NIGHT_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.instance().makeId("biome.icy.night"));
    }
