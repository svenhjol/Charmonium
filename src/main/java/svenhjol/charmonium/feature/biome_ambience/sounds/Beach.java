...
public class Beach implements ISoundType<BiomeSound> {
    ...
    public Beach() {
        DAY_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.instance().makeId("biome.beach.day"));
        NIGHT_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.instance().makeId("biome.beach.night"));
    }
