...
public class Swamp implements SoundType<BiomeSound> {
    ...
    public Swamp() {
        daySound = SoundEvent.createVariableRangeEvent(new ResourceLocation(Charmonium.ID, "biome.swamp.day"));
        nightSound = SoundEvent.createVariableRangeEvent(new ResourceLocation(Charmonium.ID, "biome.swamp.night"));
    }
