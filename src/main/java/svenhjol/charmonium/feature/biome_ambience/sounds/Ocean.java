...
public class Ocean implements SoundType<BiomeSound> {
    ...
    public Ocean() {
        daySound = SoundEvent.createVariableRangeEvent(new ResourceLocation(Charmonium.ID, "biome.ocean.day"));
        nightSound = SoundEvent.createVariableRangeEvent(new ResourceLocation(Charmonium.ID, "biome.ocean.night"));
    }
