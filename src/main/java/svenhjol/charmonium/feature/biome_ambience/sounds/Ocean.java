...
public class Ocean implements ISoundType<BiomeSound> {
    ...
    public Ocean() {
        DAY_SOUND = SoundEvent.createVariableRangeEvent(CharmoniumClient.instance().makeId("biome.ocean.day"));
        NIGHT_SOUND = SoundEvent.createVariableRangeEvent(CharmoniumClient.instance().makeId("biome.ocean.night"));
    }
