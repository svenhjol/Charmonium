...
import svenhjol.charm_api.event.ClientEntityLeaveEvent;
...
@ClientFeature(mod = Charmonium.MOD_ID, switchable = true, description = "Plays ambient sound according to features of the world around the player.")
public class WorldAmbience extends CharmFeature {
    ...
    public static List<String> caveDimensions = Arrays.asList(
        "minecraft:overworld"
    );
