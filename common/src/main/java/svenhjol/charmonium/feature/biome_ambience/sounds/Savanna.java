...
public class Savanna implements ISoundType<BiomeSound> {
    ...
    public Savanna() {
        DAY_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.makeId("biome.savanna.day"));
        NIGHT_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.makeId("biome.savanna.night"));
    }
