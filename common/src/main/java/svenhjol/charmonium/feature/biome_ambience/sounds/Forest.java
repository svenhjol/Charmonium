...
public class Forest implements ISoundType<BiomeSound> {
    ...
    public static final Predicate<Holder<Biome>> VALID_BIOME =
        holder -> holder.is(BiomeTags.IS_FOREST) || holder.is(BiomeTagHelperProxy.getForest());

    public Forest() {
        DAY_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.makeId("biome.forest.day"));
        NIGHT_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.makeId("biome.forest.night"));
    }
