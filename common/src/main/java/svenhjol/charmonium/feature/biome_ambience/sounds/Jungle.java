...
public class Jungle implements ISoundType<BiomeSound> {
    ...
    public static final Predicate<Holder<Biome>> VALID_BIOME =
        holder -> holder.is(BiomeTags.IS_JUNGLE) || holder.is(BiomeTagHelperProxy.getJungle());

    public Jungle() {
        DAY_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.makeId("biome.jungle.day"));
        NIGHT_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.makeId("biome.jungle.night"));
    }
