...
public class Icy implements ISoundType<BiomeSound> {
    ...
    public static final Predicate<Holder<Biome>> VALID_BIOME =
        holder -> holder.is(BiomeTagHelperProxy.getIcy()) || holder.is(BiomeTagHelperProxy.getSnowy());

    public Icy() {
        DAY_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.makeId("biome.icy.day"));
        NIGHT_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.makeId("biome.icy.night"));
    }
