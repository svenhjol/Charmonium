...
public class Desert implements ISoundType<BiomeSound> {
    ...
    public static final Predicate<Holder<Biome>> VALID_BIOME =
        holder -> holder.is(BiomeTagHelperProxy.getDesert());

    public Desert() {
        DAY_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.makeId("biome.desert.day"));
        NIGHT_SOUND = SoundEvent.createVariableRangeEvent(Charmonium.makeId("biome.desert.night"));
    }
